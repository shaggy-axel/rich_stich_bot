...
def create_calendar(year=datetime.now().year, month=datetime.now().month):
    ...
    inline_kb.row()
    inline_kb.insert(InlineKeyboardButton("<year", callback_data=calendar_callback.new("PREV-YEAR", year, month, 1)))
    inline_kb.insert(InlineKeyboardButton(f'{calendar.month_name[month]} {str(year)}', callback_data=ignore_callback))
    inline_kb.insert(InlineKeyboardButton("year>", callback_data=calendar_callback.new("NEXT-YEAR", year, month, 1)))
    ...
    # Last row - Buttons
    inline_kb.row()
    inline_kb.insert(InlineKeyboardButton("<month", callback_data=calendar_callback.new("PREV-MONTH", year, month, day)))
    inline_kb.insert(InlineKeyboardButton(" ", callback_data=ignore_callback))
    inline_kb.insert(InlineKeyboardButton("month>", callback_data=calendar_callback.new("NEXT-MONTH", year, month, day)))
